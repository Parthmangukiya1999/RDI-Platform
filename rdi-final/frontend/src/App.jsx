...
import StudentProfileScore from "./components/Student/StudentProfileScore";
    ...
    <Router>
      <Routes>
        ...
        >
          ...
          <Route path="score-profile" element={<StudentProfileScore />} />
        ...
        <Route
          path="/admin"
          element={
            <ProtectedRoute allowedRole={["mentor", "admin"]}>
              <AdminLayout />
            </ProtectedRoute>
          }
        >
